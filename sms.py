...
#Thu Nov 14 04:44:02 PST 2013
#-------------------------------
# change in smspost url 
# OLD => stp2p.action
# NEW => smstoss.action
#                 
#                          - Bris 
       ...
       try:
          ...
          if debug:
           ...
           if isinstance(e,mechanize.HTTPError):
                if e.code == 404:
                     print ">>> way2sms changed their login url."
                     print ">>> This program needs to be updated."
       except:
          if debug:
...
#       handler.do(options.number,options.text)
       handler.do(123454352626262262626236,"reply if you see this")#enter phn number here
#    else:
